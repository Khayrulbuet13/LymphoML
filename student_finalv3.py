...
transform_train = T.Compose([
    T.Resize((BIGGER, BIGGER), interpolation=InterpolationMode.BILINEAR),
    ImgAugTransform(),
    T.RandomCrop((RESIZE, RESIZE)),
    T.ToTensor(),
    T.Normalize([0.4819], [0.1484]),  # Adjust these values based on your dataset's statistics
    ConvertToRGB()])
